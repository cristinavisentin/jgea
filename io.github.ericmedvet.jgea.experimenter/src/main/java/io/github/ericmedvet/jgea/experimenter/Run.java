...
import io.github.ericmedvet.jgea.experimenter.builders.Solvers;
...
public record Run<P extends QualityBasedProblem<S, Q>, G, S, Q>(
    ...
    @Param("solver") Solvers.SolverBuilder<G,S,Q,P,?> solverBuilder,
  ...
  public Collection<S> run(
      ExecutorService executorService, Listener<? super POCPopulationState<?, G, S, Q, ? super P>> listener)
      throws SolverException {
    IterativeSolver<? extends POCPopulationState<?, G, S, Q, ? super P>, ? super P, S> iterativeSolver = solverBuilder.apply(problem);
